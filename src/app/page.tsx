...
import { ArrowRight, Code, Database, BrainCircuit, Github, Linkedin, Mail, FileText, X, ExternalLink, ChevronDown, Terminal, Briefcase, ArrowUp, Menu, Send } from "lucide-react";
          ...
          <div className="container mx-auto px-4 relative max-w-5xl">
            ...
            <AnimatedSection>
              <div className="grid md:grid-cols-2 gap-12 items-start mt-8">
                ...
                <motion.div variants={fadeUp} className="text-center md:text-left">
                  ...
                  <motion.div variants={staggerContainer} className="flex flex-col gap-4">
                    {[
                      ...
                      <motion.a key={idx} variants={staggerItem} whileHover={{ x: 4 }} href={social.href} target="_blank" rel="noopener noreferrer" className="flex items-center justify-center md:justify-start gap-4 p-4 bg-white dark:bg-gray-900 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-100 dark:border-gray-800 group">
                ...
                {/* Bagian Kanan: Formulir Kontak Web3Forms */}
                <motion.div variants={fadeUp} className="bg-white dark:bg-gray-900 rounded-2xl p-6 md:p-8 shadow-xl shadow-blue-500/5 border border-gray-100 dark:border-gray-800">
                  <form action="https://api.web3forms.com/submit" method="POST" className="flex flex-col gap-5">
                    {/* Menggunakan Access Key dari user */}
