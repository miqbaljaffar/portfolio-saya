          ...
          {categories.map((cat) => {
            ...
            return (
              <button
                ...
                className={`px-3 sm:px-4 md:px-5 py-1.5 sm:py-2 text-[11px] sm:text-xs md:text-sm font-mono uppercase tracking-spacex-sm rounded-none transition-all duration-300 border ${
                  isActive
