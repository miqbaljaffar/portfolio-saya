...
export default function ExperienceSection() {
  return (
    <section id="journey" className="relative py-20 sm:py-24 md:py-32 px-4 sm:px-5 md:px-10 bg-spacex-dark">
          ...
          <ul className="space-y-6 sm:space-y-8 md:space-y-10">
            {experienceData.map((item, i) => {
              ...
              return (
                ...
                >
                  <span className="absolute -left-[22px] sm:-left-[26px] md:-left-[30px] top-1 flex items-center justify-center size-4 sm:size-5 md:size-6 rounded-sm border-2 border-spacex-dark bg-spacex-flame z-10">
                  ...
                  <article className="bg-spacex-void border border-spacex-graphite rounded-none p-4 sm:p-5 md:p-6 hover:border-spacex-silver transition-colors duration-300">
                    ...
                    <p className="text-xs sm:text-sm text-spacex-muted leading-relaxed">{item.description}</p>
                  </article>
                </li>
              );
            })}
