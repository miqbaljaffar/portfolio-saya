...
export function SectionHeading({
  ...
  return (
    <div
      className={`max-w-4xl mx-auto mb-10 sm:mb-14 md:mb-20 space-y-4 sm:space-y-5 ${align === "left" ? "text-left mx-0" : "text-center"}`}
    >
      ...
      <h2 className="animate-fade-up delay-100 text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-display font-black uppercase tracking-tight text-white leading-[1.1]">
        {title}
      </h2>
